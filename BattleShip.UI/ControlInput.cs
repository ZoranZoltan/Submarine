...
namespace BattleShip.UI
{
    public class ControlInput
    {
        public static string[] GetNameFromUser()
        {
            ...
            do
            {
                Console.Write("Igraj protiv kompjutera y(da), n(ne) ?Y/N : ");
                strComputer = Console.ReadLine(); strComputer = strComputer.Trim().ToLower();
                if (strComputer == "y")
                {
                    do
                    {
                        Console.Write("Izaberi nivo e(laki), m(srednji), h(teški) ?E/M/H : ");
            ...
            do
            {
                Console.Write("Unesi ime igraca 1: ");
            ...
            if (strComputer.ToLower() == "n")
            {
                do
                {
                    Console.Write("Unesi i me igraca 2: ");
        ...
        public static bool IsPlaceBoardAuto()
        {
            ...
            do
            {
                Console.Write("Neka igrica sama postavi brodove na tabli y(da), n(ne)?Y/N : ");
        ...
        public static PlaceShipRequest GetLocationFromUser(string ShipType)
        {
            ...
            do
            {
                ...
                Console.WriteLine("Pogrešan unos, unesi tačnu lokaciju i tip broda. Ex:) a2, r");
        ...
        public static Coordinate GetShotLocationFromUser()
        {
            ...
            while (true)
            {
                Console.Write("Unesi koordinate i pucaj ");
        ...
        {
            Console.WriteLine("Pritisni F5 da nastaviš, ili bilo koje dugme da izadjes...");
